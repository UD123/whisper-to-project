...
export const en = {
  ...
  hero: {
    ...
    subtitle:
      "Transform any standard camera into a 3D measurement device. Detect exact 3D coordinates (Tx, Ty, Tz, Rx, Ry, Rz) under 30 ms and sub millimeter precision. No cloud connection or expensive 3D LiDAR or stereo sensors are required.",
  ...
  download: {
    ...
    subtitle: "Download the Pose6D runtime and calibration tools for your platform.",
    windows: {
      title: "Windows",
...
export const zh: Dict = {
  ...
  download: {
    eyebrow: "Pose6D",
    title: "软件下载",
    subtitle: "为您的平台下载 Pose6D 运行时与标定工具。",
    windows: {
      title: "Windows",
