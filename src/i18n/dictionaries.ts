...
export const en = {
  ...
  footer: {
    ...
    presence: "RobotAI Ltd. | Global presence: Korea • Poland",
...
export const zh: Dict = {
    ...
    rows: [
      {
        ...
        modern: "低成本方案 —— 兼容标准 RGB 相机（含微型 USB 相机）与常规工业电脑。",
      },
      {
        dimension: "表面与材质限制",
        legacy: "在抛光金属、反光螺栓和半透明零件上完全失效或噪声严重。",
        modern: "材质无关 —— 可稳定处理高反光、镜面和多纹理零件。",
      },
      {
        dimension: "阴影、边缘与遮挡",
        legacy: "锐利轮廓处误差密集，主动光源还会产生盲区。",
        modern: "直接输出 6DOF —— 利用清晰的 RGB 对比与视觉边缘即时给出 XYZ 与旋转向量。",
      },
      {
        dimension: "部署灵活性与工作距离",
        legacy: "工作距离受限，标定范围僵化。",
        modern: "完全灵活部署 —— 相机与物体距离可调，占用空间小。",
      },
      {
        dimension: "算力开销",
        legacy: "性能瓶颈严重，依赖复杂的点云分割算法。",
        modern: "30 毫秒内推理 —— 轻量化处理，无需点云开销即可快速获得坐标。",
      },
    ],
  },
  applications: {
    eyebrow: "02 — 应用场景",
    title: "经现场验证的工业应用",
    subtitle: "解决物体位置与朝向始终不固定的「抓取与放置」难题。",
    items: {
      bin_picking: {
        title: "无序料箱抓取",
        desc: "深料箱中的小零件、反光螺栓与杂乱朝向。",
      },
      machine_tending: {
        title: "机床上下料",
        desc: "精确定位、CNC 上下料、冲压作业。",
      },
      object_localization: {
        title: "单个与多个物体 3D 定位",
        desc: "抛光金属、半透明塑料、小螺栓、覆膜件。",
      },
      palletizing: {
        title: "码垛与拆垛",
        desc: "纸箱、多物体堆叠、动态仓储物流。",
      },
      assembly: {
        title: "精密定位与装配",
        desc: "连接器插接、电路板对位、轨迹跟踪。",
      },
      agv_docking: {
        title: "AGV、叉车与托盘对接",
        desc: "不同载荷条件下的托盘相对定位。",
      ...
      agritech: {
        title: "农业科技 / 特殊应用",
        desc: "蘑菇生长分析、叶片检测、花卉切割点估计。",
      },
    },
    ctaEyebrow: "您的零件",
    ctaTitle: "列表中没有您的零件？把样件发给我们。",
    ctaDesc: "我们会针对您自己的几何形状与表面（反光、半透明或可变形）运行位姿估计评测。",
    ctaButton: "申请评测",
  },
  workflow: {
    eyebrow: "03 — 工作流程",
    title: "三步部署流程",
    subtitle: "三个简单步骤即可接入任意相机与工业机器人手臂。",
    steps: [
      {
        n: "01",
        title: "物体扫描",
        desc: "使用单个 RGB 相机从不同位置和角度扫描您的物体。",
      },
      {
        n: "02",
        title: "模型生成",
        desc: "标注采集到的图像数据，构建统一的 AI 物体模型。",
      },
      {
        n: "03",
        title: "位姿估计",
        desc: "实时检测物体并将 6DOF 向量推送给机器人。",
      },
    ],
  ...
  about: {
    eyebrow: "07 — 关于我们",
    title: "关于 RobotAI",
    body: "我们是一家颠覆工业自动化的深科技软件公司。通过用高性能 RGB 视觉算法取代复杂昂贵的 3D 硬件与激光雷达，我们以远低于传统方案的成本，为机器人系统带来即时、与材质无关的 6DOF 感知能力。",
  },
  faq: {
    eyebrow: "08 — 常见问题",
    title: "B2B 常见问题",
  ...
  footer: {
    ...
    presence: "RobotAI Ltd. | 全球布局：韩国 • 波兰",
