    ...
    tabs: [
      {
        ...
        steps: [
          ...
          { body: "Choose the working project directory and select usb_test.", menu: ["Project", "Select Object Directory"], shot: "ui-select-folder" },
          { body: "The window stays white and reports “Config is OK”.", menu: ["Project", "Check Config File"], shot: "ui-config-ok" },
          {
          ...
          { body: "Press q to stop. If the video runs fast, the installation is successful.", result: true, shot: "ui-live-usb" },
        ],
      },
      {
        id: "own",
        ...
        steps: [
          ...
          { body: "Select Webcam 0 or 1, depending on your computer.", menu: ["Camera", "Select from List"], shot: "ui-camera-list" },
          ...
          { body: "A small live window appears. Keep the white paper behind the object.", menu: ["Detect", "Run Video from Camera"], shot: "ui-live-camera" },
